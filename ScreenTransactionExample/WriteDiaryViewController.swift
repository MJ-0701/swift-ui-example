...
class WriteDiaryViewController: UIViewController {
    ...
    private func configureDatePicker(){
        ...
        self.datePicker.locale = Locale(identifier: "ko-KR") // 한국식으로 표현
    }
    ...
    private func validateInputField(){
        self.confirmButton.isEnabled = !(self.titleTextField.text?.isEmpty ?? true) && !(self.dateTextField.text?.isEmpty ?? true)
