...
class SettingViewController: UIViewController {
    ...
    @IBOutlet weak var yelowButton: UIButton!
    ...
    private func changeTextColor(color : UIColor){
        self.yelowButton.alpha = color == UIColor.yellow ? 1 : 0.2
